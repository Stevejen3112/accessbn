...
function installerEnvValue($basePath, $key, $default = null)
{
...
if (installerEnvValue($basePath, 'APP_ENV') === 'production' && installerEnvValue($basePath, 'INSTALLER_ENABLED', 'false') !== 'true') {
    http_response_code(404);
    exit;
}

ini_set('display_errors', installerEnvValue($basePath, 'APP_ENV') === 'production' ? '0' : '1');
