...
@section('content')
            ...
            <div class="container mx-auto px-4 relative">
                        ...
                        <div data-plan-id="{{ $plan->id }}" data-cursor-label="View Strategy"
                            ...
                            <div class="relative z-10 flex flex-col h-full">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2 group/btn cursor-default">
                                        <span class="text-sm font-bold text-white/60">{{ __('Strategy Active') }}</span>
                                        <svg class="w-4 h-4 text-accent-primary/50" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="mt-16 text-center">
                    <div class="inline-flex items-center gap-4 group cursor-default">
                        <span class="text-text-secondary font-bold">{{ __('Explore All Portfolios') }}</span>
                        <div
                            class="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center transition-all bg-white/5">
    ...
    @if (moduleEnabled('trading_bot_module'))
        @if (!empty($botTrading) && (!empty($botTrading['exchanges']) || !empty($botTrading['crypto_markets'])))
            <section id="trading-bots" class="py-32 relative overflow-hidden bg-[#05070A]">
                {{-- Dynamic Background --}}
                <div
                    class="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(59,130,246,0.05)_0%,transparent_70%)]">
                </div>
                <div
                    class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[1px] bg-gradient-to-r from-transparent via-accent-primary/20 to-transparent">
                </div>

                <div class="container mx-auto px-4 relative z-10">
                    {{-- BOLD TWO-COLUMN HEADER --}}
                    <div class="grid lg:grid-cols-12 gap-12 items-center mb-24">
                        <div class="lg:col-span-8 text-center lg:text-left">
                            <span
                                class="inline-block px-4 py-1.5 rounded-full bg-accent-primary/10 border border-accent-primary/20 text-accent-primary text-[10px] font-black uppercase tracking-[0.4em] mb-6 animate-pulse">
                                {{ __('Live Execution') }}
                            </span>
                            <h2 class="text-5xl md:text-8xl font-black text-white leading-none tracking-tighter mb-8">
                                {{ __('Our Best') }} <br>
                                <span
                                    class="text-transparent bg-clip-text bg-gradient-to-r from-accent-primary via-white to-accent-secondary">{{ __('Trading Bots.') }}</span>
                            </h2>
                            <p class="text-text-secondary text-lg md:text-xl leading-relaxed max-w-2xl lg:mx-0 mx-auto">
                                {{ __('Simple, powerful trading bots that work for you 24/7. Watch them trade across the most popular crypto and currency markets with total transparency.') }}
                            </p>
                        </div>
                            ...
                            @if ($featuredBots->count() > 0)
                                <div class="relative h-[450px] w-full flex items-center justify-center">
                                    ...
                                    <svg class="absolute inset-0 w-full h-full pointer-events-none z-0"
                                        ...
                                        <defs>
                                            <linearGradient id="header-stream-gradient-1" x1="0%" y1="0%"
                                                x2="100%" y2="100%">
                                                <stop offset="0%" stop-color="rgba(59, 130, 246, 0)" />
                                                <stop offset="50%" stop-color="#3b82f6" />
                                                <stop offset="100%" stop-color="#3b82f6" />
                                            </linearGradient>
                                            <linearGradient id="header-stream-gradient-2" x1="0%" y1="0%"
                                                x2="0%" y2="100%">
                                                <stop offset="0%" stop-color="#3b82f6" />
                                                <stop offset="50%" stop-color="#7c3aed" />
                                                <stop offset="100%" stop-color="#7c3aed" />
                                            </linearGradient>
                                            <linearGradient id="header-stream-gradient-3" x1="100%" y1="100%"
                                                x2="0%" y2="0%">
                                        ...
                                        {{-- 3 SHOT PATHS - Synchronized with Bot Hits --}}
                                        {{-- path 1: 0% to 33% --}}
                                        <path class="header-stream-path-step" d="M200 80 L320 280"
                                            stroke="url(#header-stream-gradient-1)" stroke-width="3"
                                            style="filter: url(#header-glow); stroke-dasharray: 100 600; animation: headerStep1 6s linear infinite;" />

                                        {{-- path 2: 33% to 66% --}}
                                        <path class="header-stream-path-step" d="M320 280 L80 280"
                                            stroke="url(#header-stream-gradient-2)" stroke-width="3"
                                            style="filter: url(#header-glow); stroke-dasharray: 100 600; animation: headerStep2 6s linear infinite;" />

                                        {{-- path 3: 66% to 100% --}}
                                        <path class="header-stream-path-step" d="M80 280 L200 80"
                                            stroke="url(#header-stream-gradient-3)" stroke-width="3"
                                            style="filter: url(#header-glow); stroke-dasharray: 100 600; animation: headerStep3 6s linear infinite;" />
                                    </svg>

                                    {{-- BOT 1 (TOP) - Hit at 0s and 6s --}}
                                    @if (isset($featuredBots[0]))
                                        <div class="absolute top-[40px] left-1/2 -translate-x-1/2 z-10 bot-anim-1">
                                            <div class="relative transition-transform hover:scale-110 duration-500">
                                                <div
                                                    class="absolute inset-0 bg-accent-primary/40 rounded-full blur-xl animate-pulse">
                                                </div>
                                                <div
                                                    class="w-28 h-28 rounded-full border-2 border-accent-primary/50 bg-[#0B0F17] p-1 shadow-[0_0_50px_rgba(59,130,246,0.6)]">
                                                    <img src="{{ asset('assets/images/bots/' . $featuredBots[0]->logo) }}"
                                                        alt="{{ $featuredBots[0]->name }}"
                                    ...
                                    {{-- BOT 2 (BOTTOM RIGHT) - Hit at 2s --}}
                                    @if (isset($featuredBots[1]))
                                        <div class="absolute bottom-[80px] right-[40px] z-10 bot-anim-2">
                                            <div class="relative transition-transform hover:scale-110 duration-500">
                                                <div class="absolute inset-0 bg-accent-secondary/40 rounded-full blur-xl animate-pulse"
                                                    style="animation-delay: 2s;"></div>
                                                <div
                                                    class="w-24 h-24 rounded-full border-2 border-accent-secondary/50 bg-[#0B0F17] p-1 shadow-[0_0_50px_rgba(124,58,237,0.6)]">
                                                    <img src="{{ asset('assets/images/bots/' . $featuredBots[1]->logo) }}"
                                                        alt="{{ $featuredBots[1]->name }}"
                                                        class="w-full h-full object-cover rounded-full">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    {{-- BOT 3 (BOTTOM LEFT) - Hit at 4s --}}
                                    @if (isset($featuredBots[2]))
                                        <div class="absolute bottom-[80px] left-[40px] z-10 bot-anim-3">
                                            <div class="relative transition-transform hover:scale-110 duration-500">
                                                <div class="absolute inset-0 bg-emerald-500/40 rounded-full blur-xl animate-pulse"
                                                    style="animation-delay: 4s;"></div>
                                                <div
                                                    class="w-24 h-24 rounded-full border-2 border-emerald-500/50 bg-[#0B0F17] p-1 shadow-[0_0_50px_rgba(16,185,129,0.6)]">
                                                    <img src="{{ asset('assets/images/bots/' . $featuredBots[2]->logo) }}"
                                                        alt="{{ $featuredBots[2]->name }}"
                                                        class="w-full h-full object-cover rounded-full">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <style>
                                    /* PATH ANIMATIONS (6s total loop) */
                                    @keyframes headerStep1 {
                                        0% {
                                    ...
                                    /* BOT HIT ANIMATIONS */
                                    .bot-anim-1 {
                                        animation: botWobble1 6s ease-in-out infinite;
                                    }

                                    .bot-anim-2 {
                                        animation: botWobble2 6s ease-in-out infinite;
                                    }

                                    .bot-anim-3 {
                                        animation: botWobble3 6s ease-in-out infinite;
                                    }

                                    @keyframes botWobble1 {
                                        ...
                                        2% {
                                            transform: translate(-50%, -15px) scale(1.1) rotate(5deg);
                                        }

                                        /* THE HIT from step 3 */
                                        5% {
                                            transform: translate(-50%, 5px) scale(1) rotate(-5deg);
                                        }
                                    ...
                                    @keyframes botWobble2 {
                                        ...
                                        33% {
                                            transform: translate(15px, 10px) scale(1.1) rotate(5deg);
                                        }
                    ...
                    <div class="grid lg:grid-cols-12 gap-12 items-start">
                        {{-- EXCHANGES: SCROLLING LOGO WALL --}}
                        <div class="lg:col-span-12 mb-12">
                            <div class="flex flex-col md:flex-row items-center justify-between mb-10 gap-6">
                                <h3 class="text-2xl font-black text-white flex items-center gap-4">
                                    <span class="w-12 h-1 bg-accent-primary rounded-full"></span>
                                    {{ __('Where Our Bots Trade') }}
                                </h3>
                                <div
                                    class="flex items-center gap-2 text-text-secondary/60 text-xs font-bold uppercase tracking-widest">
                                    <span class="w-2 h-2 rounded-full bg-emerald-500 animate-ping"></span>
                                    {{ __('Connected to') }} {{ count($botTrading['exchanges'] ?? []) }}+
                                    {{ __('global venues') }}
                                </div>
                            </div>

                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                                @foreach (array_slice($botTrading['exchanges'], 0, 5) as $exchange)
                                    @php
                                        $logoName = strtolower(str_replace('.', '', $exchange)) . '.svg';
                                        $logoPath = public_path('assets/images/exchanges/' . $logoName);
                                    @endphp
                                    <div
                                        class="group relative aspect-[3/2] rounded-[2rem] bg-white/[0.02] border border-white/5 p-8 flex flex-col items-center justify-center hover:bg-white/[0.05] hover:border-accent-primary/30 transition-all duration-500 hover:-translate-y-2">
                                        <div
                                            class="absolute inset-0 bg-gradient-to-br from-accent-primary/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-[2rem]">
                                        </div>
                                        <div
                                            class="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform overflow-hidden">
                                            ...
                                            @else
                                                <span
                                                    class="text-2xl font-black text-white/20 group-hover:text-accent-primary transition-colors">{{ substr($exchange, 0, 1) }}</span>
                                            @endif
                                        </div>
                                        <span
                                            class="text-white font-black text-sm tracking-tight group-hover:text-accent-primary transition-colors text-center">{{ $exchange }}</span>
                                        <div
                                            class="mt-2 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <span class="w-1 h-1 rounded-full bg-emerald-500"></span>
                                            <span
                                                class="text-[8px] font-bold text-emerald-500 uppercase tracking-tighter">{{ __('Online') }}</span>
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                {{-- Creative "More" Card --}}
                                <div
                                    class="group relative aspect-[3/2] rounded-[2rem] bg-accent-primary border border-accent-primary/20 p-8 flex flex-col items-center justify-center hover:shadow-[0_0_50px_rgba(59,130,246,0.3)] transition-all duration-500 cursor-pointer overflow-hidden">
                                    <div
                                        class="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-black/20 to-transparent">
                                    </div>
                                    <span class="text-white font-black text-2xl mb-1 relative z-10">15+</span>
                                    <span
                                        class="text-white/80 font-bold text-[10px] uppercase tracking-[0.2em] relative z-10 text-center leading-tight">{{ __('Other') }}
                                        <br> {{ __('Places') }}</span>
                                    <div
                                        class="absolute -top-4 -right-4 w-12 h-12 bg-white/10 rounded-full blur-xl group-hover:scale-150 transition-transform">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="lg:col-span-8">
                            <div
                                class="bg-white/[0.02] border border-white/5 rounded-[3rem] p-10 relative overflow-hidden group">
                                <div
                                    class="absolute top-0 right-0 w-[400px] h-[400px] bg-accent-secondary/5 rounded-full blur-[100px]">
                                </div>

                                <div class="flex items-center justify-between mb-12">
                                    <h3 class="text-2xl font-black text-white">{{ __('Top Markets') }}</h3>
                                    <div
                                        class="px-4 py-2 rounded-xl bg-accent-secondary/10 border border-accent-secondary/20 flex items-center gap-3">
                                        <div class="flex -space-x-2">
                                            <div
                                                class="w-6 h-6 rounded-full bg-orange-500 border-2 border-[#0B0F17] flex items-center justify-center text-[10px] font-bold text-white">
                                                ₿</div>
                                            <div
                                                class="w-6 h-6 rounded-full bg-blue-500 border-2 border-[#0B0F17] flex items-center justify-center text-[10px] font-bold text-white">
                                                Ξ</div>
                                            <div
                                                class="w-6 h-6 rounded-full bg-emerald-500 border-2 border-[#0B0F17] flex items-center justify-center text-[10px] font-bold text-white">
                                                $</div>
                                        </div>
                                        <span
                                            class="text-[10px] font-bold text-accent-secondary uppercase tracking-widest">{{ __('Multi-Asset') }}</span>
                                    </div>
                                </div>

                                <div class="grid md:grid-cols-2 gap-10">
                                    {{-- Crypto --}}
                                    @if (!empty($botTrading['crypto_markets']))
                                        <div>
                                            <h4
                                                class="text-[10px] font-black text-text-secondary uppercase tracking-[0.3em] mb-6 flex items-center gap-2">
                                                <span class="w-2 h-2 rounded-full bg-accent-primary"></span>
                                                {{ __('Crypto Pairs') }}
                                            </h4>
                                            <div class="space-y-3">
                                                @foreach (array_slice($botTrading['crypto_markets'], 0, 6) as $pair)
                                                    <div
                                                        class="flex items-center justify-between p-3 rounded-2xl bg-white/[0.03] border border-white/5 hover:bg-white/[0.08] transition-all group/pair cursor-default">
                                                        <div class="flex items-center gap-3">
                                                            <div
                                                                class="w-8 h-8 rounded-xl bg-accent-primary/10 flex items-center justify-center text-accent-primary text-[10px] font-bold">
                                                                {{ substr($pair, 0, 1) }}
                                                            </div>
                                                            <span
                                                                class="text-sm font-bold text-white/80 group-hover/pair:text-white transition-colors">{{ $pair }}</span>
                                                        </div>
                                                        <div class="flex items-center gap-2">
                                                            <div
                                                                class="w-1 h-1 rounded-full bg-accent-primary group-hover/pair:scale-125 transition-transform">
                                                            </div>
                                                            <span
                                                                class="text-[10px] font-mono text-text-secondary/40">{{ __('LIVE') }}</span>
                                                        </div>
                                                    </div>
                                                @endforeach
                                                <div class="text-center pt-2">
                                                    <span
                                                        class="text-[10px] font-black text-accent-primary uppercase tracking-[0.2em] cursor-pointer hover:text-white transition-colors">
                                                        +244 {{ __('More Pairs') }} ...
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    {{-- Forex --}}
                                    @if (!empty($botTrading['forex_markets']))
                                        <div>
                                            <h4
                                                class="text-[10px] font-black text-text-secondary uppercase tracking-[0.3em] mb-6 flex items-center gap-2">
                                            ...
                                            <div class="space-y-3">
                                                @foreach (array_slice($botTrading['forex_markets'], 0, 6) as $pair)
                                                    <div
                                                        class="flex items-center justify-between p-3 rounded-2xl bg-white/[0.03] border border-white/5 hover:bg-white/[0.08] transition-all group/pair cursor-default">
                                                        <div class="flex items-center gap-3">
                                                            <div
                                                                class="w-8 h-8 rounded-xl bg-accent-secondary/10 flex items-center justify-center text-accent-secondary text-[10px] font-bold">
                                                                {{ substr($pair, 0, 1) }}
                                                            </div>
                                                            <span
                                                                class="text-sm font-bold text-white/80 group-hover/pair:text-white transition-colors">{{ $pair }}</span>
                                                        ...
                                                        <div class="flex items-center gap-2">
                                                            <div
                                                                class="w-1 h-1 rounded-full bg-accent-secondary group-hover/pair:scale-125 transition-transform">
                                                            </div>
                                                            <span
                                                                class="text-[10px] font-mono text-text-secondary/40">{{ __('LIVE') }}</span>
                                                        </div>
                                                ...
                                                <div class="text-center pt-2">
                                                    <span
                                                        class="text-[10px] font-black text-accent-secondary uppercase tracking-[0.2em] cursor-pointer hover:text-white transition-colors">
                                                        +48 {{ __('More Markets') }} ...
                                                    </span>
                                                </div>
                                            </div>
                        ...
                        <div class="lg:col-span-4 h-full">
                            <div class="flex flex-col h-full gap-6">
                                <div
                                    class="flex-1 bg-accent-primary border border-accent-primary/20 rounded-[3rem] p-10 relative overflow-hidden group">
                                    <div
                                        class="absolute -top-24 -right-24 w-64 h-64 bg-white/20 rounded-full blur-3xl group-hover:scale-150 transition-transform">
                                    </div>

                                    <div class="relative z-10 flex flex-col h-full">
                                        <h3 class="text-3xl font-black text-white mb-6 leading-tight">
                                            {{ __('Ready to Start') }} <br> {{ __('Bot Trading?') }}
                                        </h3>
                                        <p class="text-white/80 font-medium mb-12">
                                            {{ __('Pick a bot, set your preferences, and start trading in under 2 minutes. No technical skills required.') }}
                                        </p>

                                        <div class="mt-auto">
                                            <a href="{{ route('trading-bots') }}"
                                                class="w-full inline-flex items-center justify-between px-8 py-5 bg-white rounded-2xl text-accent-primary font-black uppercase tracking-widest text-sm hover:bg-white/90 transition-all hover:-translate-y-1 hover:shadow-2xl">
                                                {{ __('View Trading Bots') }}
                                ...
                                <div class="bg-white/[0.02] border border-white/5 rounded-[2.5rem] p-8">
                                    <div class="flex items-center gap-4">
                                        <div class="w-12 h-12 rounded-full border-2 border-accent-primary/20 p-1">
                                            <div
                                                class="w-full h-full rounded-full bg-accent-primary flex items-center justify-center text-white text-xs font-bold">
                                                10k+</div>
                                        </div>
                                        <div>
                                            <div class="text-white font-black text-lg">{{ __('12,482') }}</div>
                                            <div
                                                class="text-[10px] font-bold text-text-secondary uppercase tracking-widest">
                                                {{ __('Bots active today') }}</div>
                                        </div>
                                    </div>
                                </div> {{-- end flex --}}
                    ...
                    @if ($featuredBots->count() > 0)
                        {{-- INTEGRATED BOT LISTING --}}
                        <div class="mt-40 pt-40 border-t border-white/5 pb-20">
                            <div class="container mx-auto px-4">
                                <div
                                    class="flex flex-col md:flex-row items-center justify-between mb-16 gap-10 text-center md:text-left">
                                    <div class="max-w-xl">
                                        <h3 class="text-3xl md:text-6xl font-black text-white mb-6 tracking-tight">
                                            {{ __('Our Top') }} <br>
                                            <span
                                                class="text-transparent bg-clip-text bg-gradient-to-r from-accent-primary to-accent-secondary uppercase italic">{{ __('Performers.') }}</span>
                                        </h3>
                                        <p class="text-text-secondary text-lg lg:text-xl leading-relaxed">
                                            {{ __('Choose from our selection of high-performance bots. Each one is built for a specific market and risk level.') }}
                                        </p>
                                    </div>
                                    <div class="shrink-0">
                                        <a href="{{ route('trading-bots') }}"
                                            class="group inline-flex items-center gap-4 px-10 py-5 bg-white/5 border border-white/10 rounded-2xl text-white font-black uppercase tracking-widest text-xs hover:bg-white/10 transition-all hover:-translate-y-1">
                                            {{ __('View All Bots') }}
                                ...
                                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
                                    @foreach ($featuredBots as $bot)
                                        @include('templates.bento.blades.pages.partials.bot_card', [
                                            'bot' => $bot,
                                        ])
                                    @endforeach
                                </div>
    ...
    @if (moduleEnabled('copy_trading_module'))
        <section id="copy-trading" class="py-24 relative overflow-hidden bg-[#05070A]">
            {{-- Background Glow --}}
            <div
                class="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-accent-primary/20 to-transparent">
            </div>
            <div
                class="absolute -top-40 -left-40 w-[600px] h-[600px] bg-accent-primary/5 rounded-full blur-[120px] pointer-events-none">
            </div>

            <div class="container mx-auto px-4 relative z-10">
                <div class="grid lg:grid-cols-12 gap-16 items-center mb-24">
                    <div class="lg:col-span-12 text-center max-w-3xl mx-auto">
                        <div
                            class="inline-flex items-center gap-3 px-4 py-1.5 rounded-full border border-accent-primary/30 bg-accent-primary/5 text-accent-primary text-[10px] font-black tracking-[0.4em] uppercase mb-8 backdrop-blur-md">
                            <span class="relative flex h-2 w-2">
                                <span
                                    class="animate-ping absolute inline-flex h-full w-full rounded-full bg-accent-primary opacity-75"></span>
                                <span class="relative inline-flex rounded-full h-2 w-2 bg-accent-primary"></span>
                            </span>
                            // {{ __('ALGORITHMIC_MIRRORING_v.01') }}
                        </div>
                        <h2 class="text-4xl md:text-6xl font-black text-white leading-tight mb-8">
                            {{ __('Mirror Pros.') }} <br>
                            <span
                                class="text-transparent bg-clip-text bg-gradient-to-r from-accent-primary to-emerald-400 italic">
                                {{ __('Zero Effort.') }}
                            </span>
                        </h2>
                        <p class="text-text-secondary text-lg lg:text-xl leading-relaxed mb-12">
                            {{ __('Copy expert traders automatically. Stop guessing. Follow our top winners. Use their expert trading codes to automatically grow your money in real-time.') }}
                        </p>

                        {{-- Quick Stats Bar --}}
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                            <div
                                class="p-6 rounded-3xl bg-white/[0.02] border border-white/5 hover:border-accent-primary/20 transition-all">
                                <div
                                    class="text-[9px] font-bold text-text-secondary uppercase tracking-widest mb-2 opacity-50">
                                    {{ __('Total Profit Shared') }}</div>
                                <div class="text-2xl font-black text-emerald-400 tracking-tighter">
                                    {{ showAmount($copyTradingStats['total_profit']) }}</div>
                            </div>
                            <div
                                class="p-6 rounded-3xl bg-white/[0.02] border border-white/5 hover:border-accent-primary/20 transition-all">
                                <div
                                    class="text-[9px] font-bold text-text-secondary uppercase tracking-widest mb-2 opacity-50">
                                    {{ __('Active Operators') }}</div>
                                <div class="text-2xl font-black text-white tracking-tighter">
                                    {{ number_format($copyTradingStats['active_traders']) }}</div>
                            </div>
                            <div
                                class="p-6 rounded-3xl bg-white/[0.02] border border-white/5 hover:border-accent-primary/20 transition-all">
                                <div
                                    class="text-[9px] font-bold text-text-secondary uppercase tracking-widest mb-2 opacity-50">
                                    {{ __('Success Accuracy') }}</div>
                                @php $rate = $copyTradingStats['successful_trades'] > 0 ? ($copyTradingStats['successful_trades'] / max(1, \App\Models\CopyTradingHistory::where('status', 'completed')->count())) * 100 : 0; @endphp
                                <div class="text-2xl font-black text-blue-400 tracking-tighter">
                                    {{ number_format($rate, 1) }}%</div>
                            </div>
                        </div>
                    </div>
                </div>

                {{-- Recent Result Feed Preview --}}
                @if ($copyTradingWinners->isNotEmpty())
                    <div class="mb-16">
                        <div class="flex items-center justify-between mb-10 gap-6">
                            <h3 class="text-xl font-black text-white uppercase tracking-widest">
                                {{ __('Verified Recent Success') }}</h3>
                            <a href="{{ route('copy-trading') }}"
                                class="text-[10px] font-black text-accent-primary hover:text-white transition-colors uppercase tracking-[0.2em] border-b border-accent-primary/30 pb-0.5">
                                {{ __('View Global Results') }}
                            </a>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            @foreach ($copyTradingWinners as $trade)
                ...
                {{-- Feature CTA --}}
                <div
                    class="relative bg-gradient-to-r from-accent-primary to-accent-secondary rounded-[3rem] p-12 md:p-20 text-center overflow-hidden shadow-2xl group/cta">
                    <div
                        class="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.1),transparent_70%)] opacity-0 group-hover/cta:opacity-100 transition-opacity duration-1000">
                    </div>
                    <h3 class="text-4xl md:text-5xl font-black text-white mb-10 tracking-tight leading-none relative z-10">
                        {{ __('Choose Your Master') }} <br> {{ __('Strategy.') }}
                    </h3>
                    ...
                    @foreach ($other_team as $team)
                        <div
                            ...
                            <div class="relative z-10 flex flex-col items-center text-center">
                                <div
                                    class="w-16 h-16 lg:w-20 lg:h-20 rounded-full border-2 border-accent-primary/30 p-1 overflow-hidden mb-6">
                                ...
                                <div>
                                    ...
                                    <h3 class="text-xl font-black text-white mb-2 leading-tight">{{ __($team->name) }}
                                    </h3>
    ...
    <section id="reviews" class="py-24 relative overflow-hidden bg-[#050505]">
        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="relative group/scroll">
                <div class="flex gap-8 overflow-x-auto pb-12 snap-x snap-mandatory no-scrollbar cursor-grab active:cursor-grabbing"
                        ...
                        <div
                            ...
                            <div class="relative z-10">
                                <div class="flex items-center gap-4 mb-8">
                                    <div
                                        class="w-14 h-14 rounded-2xl border border-white/10 p-1 overflow-hidden shrink-0">
                                        @if ($review->image)
                                        ...
                                        @else
                                            <div
                                                class="w-full h-full flex items-center justify-center bg-white/5 rounded-xl">
                                                <svg class="w-6 h-6 text-slate-600" fill="none"
                                                    stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="flex gap-1">
                                    @for ($i = 0; $i < $review->rating; $i++)
                                        <svg class="w-4 h-4 text-accent-primary" fill="currentColor"
                                            viewBox="0 0 20 20">
                                            <path
                ...
                <div class="hidden md:flex justify-center gap-4 mt-8">
                    <button onclick="scrollReviews('left')"
                        class="p-4 rounded-full border border-white/5 bg-white/5 hover:bg-accent-primary hover:border-accent-primary transition-all text-white group/btn">
