                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <div class="relative">
                                        <input type="password" name="key"
                                            ...
                                            placeholder="{{ __('Publishable key') }}" class="flat-input pr-12">
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <div class="relative">
                                        <input type="password" name="secret"
                                            ...
                                            placeholder="{{ __('Secret key') }}" class="flat-input pr-12">
                                        <button type="button" class="password-toggle">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <div class="relative">
                                        <input type="password" name="webhook_secret"
                                            ...
                                            placeholder="{{ __('Webhook signing secret') }}" class="flat-input pr-12">
                                        <button type="button" class="password-toggle">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
