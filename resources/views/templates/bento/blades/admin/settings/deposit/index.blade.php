                            ...
                            @foreach ($automatic_gateways as $gateway)
                                <div class="gateway-row" id="gateway-row-{{ $gateway->id }}">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div class="flex flex-col">
                                            <span class="text-sm font-bold text-white">{{ $gateway->name }} @if (str_starts_with($gateway->pay, 'paystack'))
                                                    [{{ str_replace('_', ' ', implode(', ', json_decode($gateway->payment_information, true)['channels'])) }}]
                                                @endif
                                            </span>
                                            <div class="mt-1">
                                                <label class="switch">
