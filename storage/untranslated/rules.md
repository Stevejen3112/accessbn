...
-Chunk the batches into languages, so it will be efficient and fast. E.g Batch 1: chunk 1 = en, chunk 2 = ar, chunk 3 = fr, etc. Batch 2: chunk 1 = en, chunk 2 = ar, chunk 3 = fr, etc. 
-Once all translations are added to translator.php, then we run php translator.php.
