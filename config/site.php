...
return [
    ...
    'remote_updates_enabled' => env('LOZAND_REMOTE_UPDATES_ENABLED', false),
    'remote_patches_enabled' => env('LOZAND_REMOTE_PATCHES_ENABLED', false),
    'utility_routes_enabled' => env('LOZAND_UTILITY_ROUTES_ENABLED', false),
