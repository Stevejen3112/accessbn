...
return [
        ...
        [
            ...
            'sections' => [
                ...
                [
                    ...
                    'is_active' => moduleEnabledFromJson('investment_module') || moduleEnabledFromJson('trading_bot_module') || moduleEnabledFromJson('copy_trading_module')
                ]
            ],
            'is_external' => false,
            'is_active' => true,
    ...
    'footer_nav' => [
        ...
        [
            ...
            'is_active' => moduleEnabledFromJson('investment_module') || moduleEnabledFromJson('futures_module') || moduleEnabledFromJson('margin_module') || moduleEnabledFromJson('forex_module') || moduleEnabledFromJson('trading_bot_module')
        ],
        [
            'name' => 'Governance',
            'items' => [
