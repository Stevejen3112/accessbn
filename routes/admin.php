...
Route::middleware(['auth:admin', 'admin.otp.verified', 'sandbox'])->group(function () {
    ...
    Route::prefix('settings')->name('settings.')->group(function () {
        ...
        Route::prefix('deposit')->name('deposit.')->group(function () {
            ...
            Route::post('paystack', [DepositSettingController::class, 'updatePaystack'])->name('paystack.update');
            Route::post('razorpay', [DepositSettingController::class, 'updateRazorpay'])->name('razorpay.update');
            Route::post('stripe', [DepositSettingController::class, 'updateStripe'])->name('stripe.update');
        ...
        Route::prefix('withdrawal')->name('withdrawal.')->group(function () {
            ...
            Route::post('paystack', [WithdrawalSettingController::class, 'updatePaystack'])->name('paystack.update');
            Route::post('razorpay', [WithdrawalSettingController::class, 'updateRazorpay'])->name('razorpay.update');
